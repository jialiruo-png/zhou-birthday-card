...
const heartKeywords = [
  ...
  ['温柔有力量', 'large'], ['笃学深耕', 'small'], ['尊重包容', 'medium'], ['桃李春风', 'small'],
...
const wishOrder = ['顾言川', '方致远', '林知衡', '贺景行', '苏予宁', '秦书瑶', '沈清扬', '陆思远', '韩砚之', '宋云舟', '乔知夏', '许星澜', '宁舒然', '周明澈', '白清禾', '沈知微', '许知意', '程嘉树', '温若溪', '叶知行', '沈念初', '江屿川', '顾南乔', '陈望舒', '唐若安', '夏安宁', '陆星遥', '程予安'];
...
深夜里的详尽批注与质朴有力的教诲，是我求学期间最温暖也最有力的支持。未来无论在学术探索还是工作岗位上，我都将带着这份严谨与踏实，笃行致远。`
  },
  {
    tag: '陪伴与托举',
    title: '跨越山海的牵挂',
    summary: '从论文选题到海外联合培养，再到博士毕业求职，老师的指导从不止于科研，更像长辈般守护每一次成长。',
