const stageData = {
  portraits: [
    ...
    ['portrait-02.webp', '卡特年末工作会议留影', '2019 年 1 月 19 日', '', '在行走与交流之间，留下从容而明朗的一刻。', '供图：鄢贞', 'left'],
  ...
  wishes: [
    ...
    { name: '叶俊焘', identity: '周门弟子', text: '您常说“农业经济是大地上的论文”，而您正是那个把论文写在田垄与数据之间的人。每一次调研路上的“下一步”，每一页改满批注的草稿，都让我看见严谨如何与温情共生。愿您深耕的领域，不仅有数据的精准，更有麦浪般的诗意与回响。' },
    ...
    { name: '贾丽婼', identity: '2025 级硕士', text: '能够加入周门、成为您的学生，我感到非常幸运。在师门，我感受到的不仅是严谨与专业，更有像家一样的可靠与温暖。衷心祝愿您身体健康、岁月从容、喜乐常伴，未来的每一天都顺遂如意、幸福美满！' },
...
const STATIC_TIMINGS = { opening: 15000, chapter: 4500, photo: 4000, words: 6000, wish: 6000, story: 8000, videoIntro: 5000, achievements: 120000, closing: 20000 };
let timeline = [];
let currentIndex = 0;
let isRunning = false;
let isPaused = false;
...
function buildTimeline() {
  ...
  stageData.wishes.forEach((wish) => items.push({ type: 'wish', duration: STATIC_TIMINGS.wish, eyebrow: 'BLESSINGS', chapter: '全员祝福', wish }));
...
function renderOpening() {
  ...
  scene.innerHTML = '<div class="opening-scene__seal"><div class="opening-scene__ring"><span>周</span></div></div><div class="opening-scene__copy"><p class="kicker">TO OUR DEAREST MENTOR</p><h3>敬爱的周老师：</h3><blockquote>六十载春华秋实，您以严谨治学启迪求知，以温厚仁心守护成长。您的教诲如灯，照亮我们探索学问、奔赴人生的方向；您的关怀如春风，让周门始终温暖而坚定。<br>愿您岁月常欢、身体康健、桃李芬芳，所行皆坦途，所愿皆如意！</blockquote><p class="opening-scene__signature">周门弟子 敬贺 · 2026 年 9 月 12 日</p></div>';
...
function renderWords() {
  ...
  heading.innerHTML = '<p>IN EVERYONE\'S EYES</p><h3>大家眼中的<br>周老师</h3><small>一份份心意，汇成共同的答案</small>';
