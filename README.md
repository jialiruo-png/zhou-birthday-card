...
手机端互动纪念相册，包含开场贺卡、三章照片、文字祝福、师生故事、五段祝福视频、治学成果长卷、背景音乐与筹备组名单。项目同时提供适配宴会厅投影仪的独立 `16:9` 大屏自动播放版。

- 手机端入口：`index.html`
- 宴会大屏入口：`stage.html`
- 大屏操作说明：`README-STAGE.md`
...
- 五段视频均已转为 H.264 + AAC，背景音乐为 MP3；相关素材已全部包含在 `assets` 目录中。
- GitHub Pages 首次播放音乐时需要用户轻触页面，这是手机浏览器的自动播放规则。
